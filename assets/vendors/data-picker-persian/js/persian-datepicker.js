    ...
    _createClass(Navigator, [{
        ...
        value: function _attachEvents() {
            ...
            if (this.model.options.navigator.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .pwt-btn', function (e) {
            ...
            if (this.model.options.timePicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .up-btn', function (e) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .down-btn', function (e) {
                    var timekey = $(this).data('time-key');
            ...
            if (this.model.options.dayPicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .datepicker-day-view td:not(.disabled)', function (e) {
                ...
                $(document).on('click', '#' + that.model.view.id + ' .datepicker-day-view td.disabled', function (e) {
                    e.stopPropagation();
                });
            }
            ...
            if (this.model.options.monthPicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .datepicker-month-view .month-item:not(.month-item-disable)', function (e) {
            ...
            if (this.model.options.yearPicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .datepicker-year-view .year-item:not(.year-item-disable)', function (e) {
                    var year = $(this).data('year');
...
var Toolbox = function () {
    ...
    _createClass(Toolbox, [{
        ...
        value: function _attachEvents() {
            var that = this;
            $(document).on('click', '#' + that.model.view.id + ' .pwt-btn-today', function (e) {
            ...
            $(document).on('click', '#' + that.model.view.id + ' .pwt-btn-calendar', function (e) {
            ...
            $(document).on('click', '#' + that.model.view.id + ' .pwt-btn-submit', function (e) {
                that.model.view.hide();
